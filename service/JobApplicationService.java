...
public class JobApplicationService {
    ...
    public List<JobApplication> getJobApplicationsByTenantId(Long tenantId) {
        logger.debug("Fetching candidates for tenantId: {}", tenantId);
        return jobApplicationRepository.findByTenantId(tenantId);
    }
    ...
    public List<Candidate> getCandidateByJobIdAndTenantId(UUID jobId, Long tenantId) {
        logger.info("Inside getCandidateByJobIdAndTenantId");
        List<JobApplication> applications = jobApplicationRepository.findByJobIdAndTenantId(jobId, tenantId);
