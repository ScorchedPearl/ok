...
public class CallController {
    ...
    @PostMapping("/update")
    public ResponseEntity<Map<String, Object>> updateCallAndAddTranscripts(@RequestBody CallUpdateRequest request) {
        callService.updateCallAndAddTranscripts(request);

         Map<String, Object> response = new HashMap<>();
        response.put("success", true);
        response.put("message", "Call status updated and transcripts added successfully.");
