...
export default function LoginPageCandidate() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
        ...
        await login('candidate-realm', email, password)
        ...
        >
          <div className="text-center space-y-6">
            ...
            >
                ...
                <User className="w-12 h-12 text-[#2E2883]" />
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <motion.a
                    ...
                    whileHover={{ scale: 1.05 }}
                    className="text-[#2E2883] font-medium hover:underline pb-2"
                  >
                    Register as a Candidate
                  </motion.a>

                <p className="text-gray-600 font-medium pt-2.s">Not a Candidate?</p>
