...
public class Interview {
    ...
    @JsonBackReference(value = "candidatejob-interviews")  // Make sure this is present and matches
    ...
    @OneToMany(mappedBy = "interview", cascade = CascadeType.ALL, orphanRemoval = true)
    @Builder.Default private List<FeedbackTemplate> feedbackTemplates = new ArrayList<>();
